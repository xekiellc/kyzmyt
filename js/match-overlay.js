  ...
  async function render() {
    ...
    try {
      if (typeof supabase === "undefined") {
        throw new Error("supabase-js not loaded — add the CDN script tag before this file");
      }
      ...
      if (!data.matches || data.matches.length === 0) {
        grid.appendChild(el("div", "km-empty",
          ...
          'Try relaxing a dealbreaker, or check back soon — new members are verifying every day.'));
        return;
      }
